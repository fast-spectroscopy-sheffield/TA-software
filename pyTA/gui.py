...
class Ui_pyTAgui(object):
    def setupUi(self, pyTAgui):
        ...
        self.h_camera_box.setGeometry(QtCore.QRect(10, 10, 251, 161))
        ...
        self.h_connect_camera_btn.setGeometry(QtCore.QRect(10, 90, 111, 23))
        ...
        self.h_disconnect_camera_btn.setGeometry(QtCore.QRect(130, 90, 111, 23))
        ...
        self.h_camera_status.setGeometry(QtCore.QRect(10, 120, 231, 21))
        ...
        self.h_use_ir_gain.setGeometry(QtCore.QRect(10, 60, 221, 21))
        self.h_use_ir_gain.setObjectName("h_use_ir_gain")
        self.h_delay_box = QtWidgets.QGroupBox(self.hardware_tab)
        self.h_delay_box.setGeometry(QtCore.QRect(10, 180, 251, 131))
        ...
        self.h_motor_box.setGeometry(QtCore.QRect(10, 320, 251, 161))
        ...
        self.a_shortstage_t0.setEnabled(True)
        self.a_shortstage_t0.setGeometry(QtCore.QRect(200, 120, 41, 22))
        ...
        self.a_longstage_t0.setGeometry(QtCore.QRect(10, 70, 71, 22))
        ...
        self.label_5.setGeometry(QtCore.QRect(200, 100, 51, 21))
        self.label_5.setObjectName("label_5")
        self.label_6 = QtWidgets.QLabel(self.a_acquire_box)
        self.label_6.setGeometry(QtCore.QRect(90, 70, 141, 21))
        ...
        self.a_delaytype_dd.setGeometry(QtCore.QRect(250, 120, 81, 22))
        self.a_delaytype_dd.setObjectName("a_delaytype_dd")
        self.label_9 = QtWidgets.QLabel(self.a_acquire_box)
        self.label_9.setGeometry(QtCore.QRect(250, 100, 81, 21))
        self.label_9.setObjectName("label_9")
        self.a_pinklaser_t0 = QtWidgets.QDoubleSpinBox(self.a_acquire_box)
        self.a_pinklaser_t0.setGeometry(QtCore.QRect(10, 50, 71, 22))
        ...
        self.label_30.setGeometry(QtCore.QRect(90, 50, 141, 21))
        ...
        self.a_xpsstage_t0 = QtWidgets.QDoubleSpinBox(self.a_acquire_box)
        self.a_xpsstage_t0.setGeometry(QtCore.QRect(10, 30, 71, 22))
        self.a_xpsstage_t0.setMinimum(-100000.0)
        self.a_xpsstage_t0.setMaximum(100000.0)
        self.a_xpsstage_t0.setObjectName("a_xpsstage_t0")
        self.label_78 = QtWidgets.QLabel(self.a_acquire_box)
        self.label_78.setGeometry(QtCore.QRect(90, 30, 131, 21))
...
"background-color: rgb(0, 0, 0);")
        ...
        self.d_use_B_matrix_test = QtWidgets.QCheckBox(self.d_refmanip_box)
        self.d_use_B_matrix_test.setGeometry(QtCore.QRect(190, 30, 131, 17))
        self.d_use_B_matrix_test.setStyleSheet("color: rgb(255, 0, 0);")
        self.d_use_B_matrix_test.setAutoExclusive(False)
        self.d_use_B_matrix_test.setObjectName("d_use_B_matrix_test")
        self.label_80 = QtWidgets.QLabel(self.d_refmanip_box)
        self.label_80.setGeometry(QtCore.QRect(210, 40, 111, 81))
        ...
        self.d_xpsstage_t0 = QtWidgets.QDoubleSpinBox(self.d_acquire_box)
        self.d_xpsstage_t0.setGeometry(QtCore.QRect(10, 30, 71, 22))
        self.d_xpsstage_t0.setMinimum(-100000.0)
        self.d_xpsstage_t0.setMaximum(100000.0)
        self.d_xpsstage_t0.setObjectName("d_xpsstage_t0")
        ...
        self.d_delaytype_dd.setGeometry(QtCore.QRect(250, 130, 81, 22))
        self.d_delaytype_dd.setObjectName("d_delaytype_dd")
        self.label_39 = QtWidgets.QLabel(self.d_acquire_box)
        self.label_39.setGeometry(QtCore.QRect(250, 110, 81, 21))
        ...
        self.d_shortstage_t0.setEnabled(True)
        self.d_shortstage_t0.setGeometry(QtCore.QRect(200, 130, 41, 22))
        ...
        self.label_79 = QtWidgets.QLabel(self.d_acquire_box)
        self.label_79.setEnabled(True)
        self.label_79.setGeometry(QtCore.QRect(200, 110, 41, 21))
        ...
        self.d_save_btn = QtWidgets.QCheckBox(self.d_launch_box)
        self.d_save_btn.setGeometry(QtCore.QRect(240, 30, 91, 31))
        self.d_save_btn.setStyleSheet("background-color: rgb(0, 170, 255);")
        self.d_save_btn.setObjectName("d_save_btn")
...
"background-color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, pyTAgui):
        ...
        self.h_use_ir_gain.setText(_translate("pyTAgui", "IR Gain (recommended for NIR cameras)"))
        ...
        self.label_5.setText(_translate("pyTAgui", "Short t0"))
        ...
        self.label_78.setText(_translate("pyTAgui", "XPS Stage Time Zero"))
        ...
        self.d_use_B_matrix_test.setText(_translate("pyTAgui", "B-matrix referencing"))
        self.label_80.setText(_translate("pyTAgui", "<html><head/><body><p>(only testing for now;<br/>turn off ref. manip. or<br/>set scale factor = 1,<br/>use sufficient num. of<br/>shots, etc.)</p></body></html>"))
        ...
        self.label_35.setText(_translate("pyTAgui", "XPS Stage Time Zero"))
        ...
        self.label_79.setText(_translate("pyTAgui", "Short t0"))
        ...
        self.d_save_btn.setText(_translate("pyTAgui", "Save Next N\n"
"Shots to CSVs"))
