...
class Editor(QtGui.QMainWindow):
    def __init__(self, lif, pl=np.zeros((50,1)), preloaded=False):        
        ...
        self.num_pixels = 512  # ideally this shouldn't be hard-coded... edit when we set up IR
        ...
        if preloaded is False:  # change these values to something sensible
            ...
            self.ui.cutoff_pixel_high.setValue(570)
            self.ui.use_calib.setChecked(1)
            self.ui.calib_pixel_low.setValue(150)
            self.ui.calib_pixel_high.setValue(550)
            self.ui.calib_wave_low.setValue(900)
            self.ui.calib_wave_high.setValue(1500)
            self.ui.shortstage_t0.setValue(0)
            self.ui.longstage_t0.setValue(0)
            self.ui.pinklaser_t0.setValue(2668)
            ...
            self.ui.kinetic_pixel.setValue(250)
